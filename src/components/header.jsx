        ...
        <div className="relative flex gap-4 justify-between items-center mb-2">
          ...
          <div className="font-bold text-md flex gap-2 items-center">
            {categories?.slice(0, 5).map((category) => {
              return (
                <Link
                  className="px-4 py-1 transition ease-in-out delay-300 hover:gradient border-b-4 hidden lg:block"
                  key={category.name}
          ...
          {showCategories && (
            <div className="absolute right-0 top-14 px-10 pt-6 pb-9 w-full gradient z-20 showBox">
